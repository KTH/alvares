...
def get_slack_text(deployment, committed):
    return f'This code was pushed to :github: <https://github.com/KTH/{deployment_util.get_application_name(deployment)}| Accessibility report> github.com *{committed["readable"]}*.'
